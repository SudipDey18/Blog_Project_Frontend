...
const CreateBlog = ({ loginUser }) => {
  ...
  return (
    <>
      <div className='w-screen h-screen bg-zinc-900 flex flex-col justify-center items-center text-lg text-slate-200'>
        {/* <div className="bg-[#2D2C2B] text-lg text-slate-200 p-3 justify-items-center w-5/6 sm:w-2/5 h-4/6 rounded-3xl"> */}
        <h1 className='text-3xl font-bold mb-5 text-sky-300 mt-10' >Create a New Blog</h1>
        <form id="blogForm" onSubmit={handelSubmit} className='flex flex-col gap-3 w-full items-center h-5/6'>
